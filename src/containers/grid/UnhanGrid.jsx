...
const UnhanGrid = () => {
    ...
    useEffect(() => {
        ...
        const apiUrl = 'https://api.mockfly.dev/mocks/4150728a-8878-4427-8725-3a92fa972967/aplikasi/universitas-pertahanan'; // Replace with your API URL
